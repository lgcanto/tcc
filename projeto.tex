 		...
 		\section{Análise}
 			...
 			\subsection{Caso de 3 classes}
	 			\begin{itemize}
	 				...
	 				\item Menor acurácia: $60,21$ (BBDC4/4d)
	 				\item Média de acurácia para ABEV3: $60,21$
	 				\item Média de acurácia para BBDC4: $60,21$
	 				\item Média de acurácia para ITUB4: $60,21$
	 				\item Média de acurácia para PETR4: $60,21$
	 				\item Média de acurácia para VALE3: $60,21$
	 				\item Média de acurácia para 1 dia: $60,21$
	 				\item Média de acurácia para 2 dias: $60,21$
	 				\item Média de acurácia para 3 dias: $60,21$
	 				\item Média de acurácia para 4 dias: $60,21$
	 				\item Média de acurácia para 5 dias: $60,21$
	 				\item Média de acurácia geral: $60,21$
	 			\end{itemize}
	 			\begin{table}[h]
	 			...
	 			\end{table}
	 			\begin{itemize}
	 				\item Maior precisão média: $60,21$ (BBDC4/4d)
	 				\item Menor precisão média: $60,21$ (BBDC4/4d)
	 				\item Média de precisão média para ABEV3: $60,21$
	 				\item Média de precisão média para BBDC4: $60,21$
	 				\item Média de precisão média para ITUB4: $60,21$
	 				\item Média de precisão média para PETR4: $60,21$
	 				\item Média de precisão média para VALE3: $60,21$
	 				\item Média de precisão média para 1 dia: $60,21$
	 				\item Média de precisão média para 2 dias: $60,21$
	 				\item Média de precisão média para 3 dias: $60,21$
	 				\item Média de precisão média para 4 dias: $60,21$
	 				\item Média de precisão média para 5 dias: $60,21$
	 				\item Média de precisão média geral: $60,21$
	 			\end{itemize}
	 			\begin{table}[h]
	 			...
	 			\end{table}
				\begin{itemize}
	 				\item Maior cobertura média: $60,21$ (BBDC4/4d)
	 				\item Menor cobertura média: $60,21$ (BBDC4/4d)
	 				\item Média de cobertura média para ABEV3: $60,21$
	 				\item Média de cobertura média para BBDC4: $60,21$
	 				\item Média de cobertura média para ITUB4: $60,21$
	 				\item Média de cobertura média para PETR4: $60,21$
	 				\item Média de cobertura média para VALE3: $60,21$
	 				\item Média de cobertura média para 1 dia: $60,21$
	 				\item Média de cobertura média para 2 dias: $60,21$
	 				\item Média de cobertura média para 3 dias: $60,21$
	 				\item Média de cobertura média para 4 dias: $60,21$
	 				\item Média de cobertura média para 5 dias: $60,21$
	 				\item Média de cobertura média geral: $60,21$
	 			\end{itemize}
	 			\begin{table}[h]
	 			...
	 			\end{table}
				\begin{itemize}
	 				\item Maior medida F1: $60,21$ (BBDC4/4d)
	 				\item Menor medida F1: $60,21$ (BBDC4/4d)
	 				\item Média de medida F1 para ABEV3: $60,21$
	 				\item Média de medida F1 para BBDC4: $60,21$
	 				\item Média de medida F1 para ITUB4: $60,21$
	 				\item Média de medida F1 para PETR4: $60,21$
	 				\item Média de medida F1 para VALE3: $60,21$
	 				\item Média de medida F1 para 1 dia: $60,21$
	 				\item Média de medida F1 para 2 dias: $60,21$
	 				\item Média de medida F1 para 3 dias: $60,21$
	 				\item Média de medida F1 para 4 dias: $60,21$
	 				\item Média de medida F1 para 5 dias: $60,21$
	 				\item Média de medida F1 geral: $60,21$
	 			\end{itemize}
	 			\begin{table}[h]
