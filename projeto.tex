		  ...
		  \subsection{Número de \textit{Epochs}}
		  	...
		  	\begin{figure}[H]
		  		...
		  		{\includegraphics[width=14cm]{loss_graph}
		  			\caption{Gráfico de \textit{loss} gerado pelo TensorBoard, indicando o aumento  da perda a partir da 10ª \textit{epoch} nos treinamentos feitos para os conjuntos de três classes.}
...
%			 	\end{figure}
 		...
 		\section{Análise}
 			...
 			\paragraph{}Como foram utilizados 5 ativos, 5 períodos de tempo e duas variações (uma abrangendo duas classes e outra três classes) foi possível obter ao final 50 modelos preditivos.
			...
			\subsection{Caso de 2 classes}
				\begin{itemize}
	 				...
	 				\item Menor acurácia: $57,07$ (VALE3/3d)
				...
				\begin{itemize}
	 				...
	 				\item Menor precisão média: $57,08$ (VALE3/3d)
				...
				\begin{itemize}
	 				...
	 				\item Menor cobertura média: $57,07$ (VALE3/3d)
